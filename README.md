...
2. **Clone o repositório**: `git clone https://github.com/JhonataFerreiraJFL/proj_engc`
3. **Uso**: Abra o arquivo `index.html` no seu navegador para iniciar o aplicativo.
